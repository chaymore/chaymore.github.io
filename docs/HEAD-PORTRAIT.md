...
The lips move locally with minimal chin displacement. A shared analytic opening in the visible points and depth surface reveals a recessed stippled mouth interior without coarse triangle artifacts. This is a stylized rig, not a full anatomical facial model. Reply audio drives the existing mouth shapes from estimated visemes. Short blinks and a slight brow drift move only the stipples already on the eyes and brows. See [voice integration](PORTRAIT-VOICE.md). Floating page navigation is deferred.
