...
The lips move locally with minimal chin displacement. A shared analytic opening in the visible points and depth surface reveals a recessed stippled mouth interior without coarse triangle artifacts. This is a stylized rig, not a full anatomical facial model. Audio amplitude drives the preview; timed mouth shapes are available for a future voice provider. See [voice integration](PORTRAIT-VOICE.md). Floating page navigation is deferred.
